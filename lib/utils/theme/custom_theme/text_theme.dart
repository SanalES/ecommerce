...
//// light text theme
  ...
  bodyLarge: const TextStyle().copyWith(fontSize: 14.0 , fontWeight: FontWeight.w500 , color: Colors.black),
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 32.0 , fontWeight: FontWeight.w500 , color: Colors.black.withOpacity(0.5)),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 12.0 , fontWeight: FontWeight.normal , color: Colors.white.withOpacity(0.5)),
